...
*** TODO prevent step advancement when data entry incomplete
*** TODO deploy (goal: by Fri June 24)
** Nice-to-haves
*** TODO display responsibilities as editable list
- re-balance the nodes after removing a responsibility
- remove all descendants along with a removed responsibility
- update walkthrough to match new layout
*** TODO foreach responsibility, display needs as editable list
