...
**** TODO basic step movement (forwards and backwards)
**** TODO prevent forward stepping unless required selections made
**** TODO fill in span.wish-number dynamically
**** TODO fill in span.wish-parent-type dynamically
**** TODO fill in div.wish-parent-list dynamically
**** TODO display div.wish-resource-description dynamically
**** TODO upon "next", add wish to map and save it to backend
Need to save:
- wish_name
- wish_parent (i.e. the edge)
- wish_resource_description
**** TODO do we want completions for wish_name?
