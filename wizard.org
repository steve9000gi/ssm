...
*** TODO fix arrowheads
*** TODO save with each step next/back button click (incl. finish)
*** TODO minimize button and min/max functionality
...
** Bugs
*** TODO in entry lists, only include children of a specific type (alternatively, filter out wishes).
*** TODO able to add empty role node? Maybe by hitting "back" instead of "next"?
